...
namespace Rollrate.Data
{
    ...
    /// Thresholds from the design doc. The Scrap reward is UNIFIED across
    /// all three Tests (design: "la ricompensa di ogni Test superato è
    /// identica per tutti e tre") - it's only ONE of three choices the
    /// player picks from on success (the other two are Acquisto Gratis
    /// at the Dice Dealer / Fusione Gratuita at the Furnace, which have
    /// no Scrap value at all - see ArchiveController).
    /// </summary>
    ...
    public class ArchiveTestTable : ScriptableObject
    {
        ...
        // Risk on failure: player CHOOSES a die to lose permanently - see ArchiveController's sacrifice-choice step. No Scrap number needed here.
        ...
        [Tooltip("Scelta dell'Archivio, option 1 of 3: flat Scrap. The other two options (Acquisto Gratis / Fusione Gratuita) have no Scrap value.")]
