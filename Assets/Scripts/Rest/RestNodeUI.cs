...
namespace Rollrate.Rest
{
    ...
    /// the player's missing HP (rounded up). Loaded additively like Shop/
    /// Furnace - a Map node will call NodeSceneLoader.EnterNode("RestNodeScene")
    ...
    public class RestNodeUI : MonoBehaviour
    {
        ...
        /// <summary>Heals half the missing HP, rounded up. Only happens once per visit.</summary>
